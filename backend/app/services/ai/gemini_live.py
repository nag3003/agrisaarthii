...
async def run_live_session(): 
    load_dotenv() 
    # Use settings from our config or fallback to env
    ...
    print(f"[Agri Gemini Live] Connecting to model: {model_id}") 
    ...
    print("[Agri Gemini Live] Connected to peripherals.") 
    print("[Agri Gemini Live] Press 'q' in the video window to exit.") 
    ...
    try: 
        ...
        async with client.aio.live.connect(model=model_id, config=config) as session: 
            print("[Agri Gemini Live] Connected to Gemini. Say hello!") 
            ...
            async def capture_and_display(): 
                while state["running"]: 
                    ...
                    # Show Local Window 
                    cv2.imshow("Agri Gemini Live Vision", frame_small) 
        ...
        print("[Agri Gemini Live] Session Ended.") 
